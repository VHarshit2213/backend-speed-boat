...
import { createMilestoneSchema, updateMilestoneSchema, reorderMilestoneSchema } from "../validators/milestone.validator.js";
...
router.get("/deleted", asyncHandler(ctrl.deletedMilestoneList));
